      ...
      <View style={containerStyle}>
        <View>
          ...
          <Text style={[styles.helperText, isGenderMenuOpen && styles.helperTextHidden]}>
            No worries about personal data! We will only show your initials to the general public in
            the app, unless you choose to show your full name in the profile setting. Read about how
            we secure your data{' '}
        ...
        <View style={styles.actions}>
          <TouchableOpacity
            style={[styles.checkboxRow, isGenderMenuOpen && styles.checkboxRowHidden]}
